        ...
        <div class="p-8">
            ...
            <form method="POST" action="{{ route('login.post') }}">
                ...
                <div class="mb-5">
                    ...
                    <input type="email" name="email" value="{{ request('email') }}" placeholder="vul je email in" required class="w-full p-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#005b96] transition-colors">
                </div>
