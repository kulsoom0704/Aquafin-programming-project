        ...
        <div class="p-8">
            ...
            <form method="POST" action="<?php echo e(route('login.post')); ?>">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" value="<?php echo e(request('email')); ?>" placeholder="vul je email in" required class="w-full p-3.5 border border-gray-200 rounded-xl focus:outline-none focus:border-[#4a90d9] focus:ring-2 focus:ring-[#4a90d9]/20 transition-all duration-300 bg-white/70">
                </div>
