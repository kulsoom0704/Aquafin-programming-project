...
<div class="max-w-7xl mx-auto relative pb-24 px-4 sm:px-6 lg:px-8 mt-6">
    ...
    <div class="mb-10 flex flex-col md:flex-row justify-between md:items-end gap-6 pt-6">
        ...
        <div class="flex items-center gap-3 relative z-50">
            <a href="<?php echo e(route('materiaal.bestellen')); ?>" class="bg-white text-slate-600 border border-blue-100 hover:border-[#005b96] hover:text-[#005b96] px-5 py-2.5 rounded-xl font-bold text-sm transition-all shadow-sm flex items-center gap-2">
    ...
    <div class="space-y-4">
        <?php $__empty_1 = true; $__currentLoopData = $bestellingen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="bg-white rounded-[1.5rem] border border-blue-50 shadow-[0_2px_15px_rgba(0,91,150,0.03)] hover:shadow-[0_10px_25px_rgba(0,91,150,0.08)] hover:border-blue-200 transition-all duration-300 p-4 lg:p-5 flex flex-col md:flex-row gap-5 items-start md:items-center group">
                ...
                <div class="w-16 h-16 shrink-0 rounded-2xl bg-gradient-to-br <?php echo e($gradient); ?> flex items-center justify-center overflow-hidden shadow-inner group-hover:scale-105 transition-transform duration-500">
                    <?php if(isset($order->materiaal->foto) && $order->materiaal->foto): ?>
                        <img src="<?php echo e(asset('storage/' . $order->materiaal->foto)); ?>" alt="Foto" class="w-full h-full object-cover">
                    <?php else: ?>
                ...
                <div class="flex-grow">
                    <div class="flex items-center gap-3 mb-1">
                        <span class="text-[10px] font-black tracking-[0.15em] text-slate-400 bg-slate-50 px-2 py-0.5 rounded"><?php echo e($order->materiaal->artikelnummer ?? 'N/A'); ?></span>
                    ...
                    <h3 class="text-lg font-extrabold text-slate-800 leading-tight group-hover:text-[#005b96] transition-colors"><?php echo e($order->materiaal->omschrijving ?? 'Onbekend materiaal'); ?></h3>
                </div>
                ...
                <div class="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto shrink-0 md:pl-6 md:border-l border-slate-100 pt-4 md:pt-0">
                    ...
                    <div class="bg-blue-50/50 border border-blue-100 px-4 py-2 rounded-xl flex items-center gap-2">
                        ...
                        <span class="text-lg font-black text-[#005b96]"><?php echo e($order->aantal); ?></span>
                    </div>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="bg-white rounded-[2rem] border border-dashed border-slate-300 p-12 flex flex-col items-center justify-center text-center shadow-sm mt-8">
                ...
                <a href="<?php echo e(route('materiaal.bestellen')); ?>" class="bg-[#005b96] hover:bg-[#003d66] text-white px-6 py-3 rounded-xl font-bold transition-all shadow-md flex items-center gap-2">
