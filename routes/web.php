...
Route::post('/bestellingen/{id}/goedkeuren', [MateriaalController::class, 'bestellingGoedkeuren']);
Route::post('/bestellingen/{id}/afwijzen', [MateriaalController::class, 'bestellingAfwijzen']);